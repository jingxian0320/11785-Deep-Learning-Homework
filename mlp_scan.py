...
class CNN_DistributedScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        w1, w2, w3 = weights
        self.conv1.W = np.transpose(w1[:24*2, :2].T.reshape((2, 2, 24)),axes = [0,2,1])
        self.conv2.W = np.transpose(w2[:4, :8].T.reshape((8, 2, 2)),axes = [0,2,1])
        self.conv3.W = np.transpose(w3.T.reshape((4, 2, 8)),axes = [0,2,1])
